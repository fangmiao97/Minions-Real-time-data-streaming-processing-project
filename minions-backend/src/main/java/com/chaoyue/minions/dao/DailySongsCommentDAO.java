...
/**
 * daily_songcomment的DAO
 */
@Component
public class DailySongsCommentDAO {

    @Autowired
    private HBaseUtils hBaseUtils;

    private static String tableName = "daily_songcomment";

    public Map<String, Long> querySongsCommentDataByDate(String date) throws IOException {
        Map<String, Long> map = new HashMap<>();

        HTable table = hBaseUtils.getTable(tableName);

        String cf = "info";
        String qualifier = "comment_count";
